...
val_csv = 'evaluation/evaluate_middle2.csv'
...
model_path='fcnn/exp_fcnn_channelattention_4class/model-245-0.9710.hdf5'
...
y_val_onehot = tensorflow.keras.utils.to_categorical(y_val, num_classes)


best_model = tensorflow.keras.models.load_model(model_path)
